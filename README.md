...
<table>
  <tr>
    <td width="75%" valign="top">
      <img src='./public/intro/main.gif' alt="게임 메이트 home페이지" width="100%">
    </td>
    <td width="25%" valign="top">
      <img src='./public/intro/mobile_home_fix.JPG' alt="게임 메이트 home페이지-m" width="100%">
    </td>
  </tr>
...
<table>
  <tr>
    <td width="75%" valign="top">
      <img src='./public/intro/dashboard.gif' alt="게임 메이트 dashboard페이지" width="100%">
    </td>
    <td width="25%" valign="top">
      <img src='./public/intro/dashboard_profile_fix.JPG' alt="게임 메이트 dashboard페이지-m" width="100%">
    </td>
  </tr>
...
<table>
  <tr>
    <td width="75%" valign="top">
      <img src='./public/intro/payment.gif' alt="게임 메이트 dashboard_token페이지" width="100%">
    </td>
    <td width="25%" valign="top">
      <img src='./public/intro/payment_m_fix.JPG' alt="게임 메이트 dashboard_token페이지지-m" width="100%">
    </td>
  </tr>
...
<table>
  <tr>
    <td width="75%" valign="top">
      <img src='./public/intro/profile_public.gif' alt="게임 메이트 dashboard_token페이지" width="100%">
    </td>
    <td width="25%" valign="top">
      <img src='./public/intro/profile_public_m.JPG' alt="게임 메이트 dashboard_token페이지지-m" width="100%">
    </td>
  </tr>
...
<table>
  <tr>
    <td width="75%" valign="top">
      <img src='./public/intro/chat.gif' alt="게임 메이트 chat페이지" width="100%">
    </td>
    <td width="25%" valign="top">
      <img src='./public/intro/chat_m_fix.JPG' alt="게임 메이트 chat페이지-m" width="100%">
    </td>
  </tr>
...
<table>
  <tr>
    <td width="75%" valign="top">
      <img src='./public/intro/reservation.gif' alt="게임 메이트 reservation페이지지" width="100%">
    </td>
    <td width="25%" valign="top">
      <img src='./public/intro/reservation_m_fix.JPG' alt="게임 메이트 reservation페이지-m" width="100%">
    </td>
  </tr>
...
<table>
  <tr>
    <td width="75%" valign="top">
      <img src='./public/intro/task.gif' alt="게임 메이트 task페이지" width="100%">
    </td>
    <td width="25%" valign="top">
      <img src='./public/intro/task_m_fix2.JPG' alt="게임 메이트 task페이지-m" width="100%">
    </td>
  </tr>
...
<table>
  <tr>
    <td width="75%" valign="top">
      <img src='./public/intro/review.gif' alt="게임 메이트 review페이지" width="100%">
    </td>
    <td width="25%" valign="top">
      <img src='./public/intro/review_m_fix.JPG' alt="게임 메이트 review페이지-m" width="100%">
    </td>
  </tr>
...
<table>
  <tr>
    <td width="75%" valign="top">
      <img src='./public/intro/category.JPG' alt="게임 메이트 review페이지" width="100%">
    </td>
    <td width="25%" valign="top">
      <img src='./public/intro/category_m2.JPG' alt="게임 메이트 review페이지-m" width="100%">
    </td>
  </tr>
