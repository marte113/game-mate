...
원빌리언스튜디오(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립, 공개합니다.
...
2. 재화 또는 서비스 제공
필수항목 : 성명, 아이디, 비밀번호, 전화번호, 이메일주소, 신용카드번호, 은행계좌정보 등 결제정보
...
성명 : 하성준
직책 : 대표
연락처 : 010-3000-2316, agopwns@gmail.com
...
이 개인정보 처리방침은 2024. 05. 13부터 적용됩니다.`}
        </pre>
      </div>
    </main>
  );
