...
export default function Follow() {
  const [follows, setFollows] = useState(MOCK_FOLLOWS)
                ...
                <div className="card-body p-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="relative">
                      ...
                      <div className={`absolute bottom-0 right-0 w-4 h-4 rounded-full border-2 border-base-100 ${follow.isOnline ? 'bg-success' : 'bg-base-300'}`}></div>
                    </div>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-2 flex flex-wrap gap-1">
                        {follow.games.map((game, index) => (
                          <span key={index} className="badge badge-outline badge-sm">{game}</span>
                        ))}
                      </div>
                    </div>
                  </div>
