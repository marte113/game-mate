...
export default function TaskDetailModal({ isReceived }) {
    ...
    <dialog open className="modal modal-bottom sm:modal-middle modal-open">
      <div className="modal-box">
        ...
        <div className="space-y-2">
          <p><span className="font-semibold w-24 inline-block">게임:</span> {task.game}</p>
          <p><span className="font-semibold w-24 inline-block">예약 일시:</span> {task.scheduled_date} {task.scheduled_time.slice(0, 5)}</p>
          ...
          <p><span className="font-semibold w-24 inline-block">상태:</span> {task.status}</p>
        </div>
