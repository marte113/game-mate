...
const Arrow = ({ extraStyle = "" }: ArrowProps) => {
  return <ArrowDown className={`shrink-0 w-12 stroke-neutral-content opacity-70 ${extraStyle}`} />
}
    ...
    <section className="bg-base-content text-neutral-content">
      <div className="max-w-7xl mx-auto px-8 py-16 md:py-32 text-center">
        ...
        <p className="max-w-xl mx-auto text-lg opacity-90 leading-relaxed mb-12 md:mb-20">
          게임을 함께할 친구를 찾기 어렵고, 혼자 플레이하다 금방 지루하고, 즐거움보다 스트레스가
          쌓이곤 합니다.
        </p>
        <div className="flex flex-col md:flex-row justify-center items-center md:items-start gap-6">
          ...
          <Step emoji="😔" text="실력 차이 나는 팀원 때문에 제대로 즐기지도 못하고 패배?" />
        </div>
      </div>
    </section>
  )
